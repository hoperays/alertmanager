...
func New(c *config.WeComRobotConfig, t *template.Template, l *slog.Logger, httpOpts ...commoncfg.HTTPClientOption) (*Notifier, error) {
...
func (n *Notifier) Notify(ctx context.Context, as ...*types.Alert) (bool, error) {
	...
	if truncated {
		n.logger.Debug("message truncated due to exceeding maximum allowed length by wecom robot", "truncated_message", content)
	}
